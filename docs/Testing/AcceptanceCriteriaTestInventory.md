...
| Aspire AppHost is built in test code, configures endpoint/API key/provider compatibility, and serves implemented modalities plus official Azure SDK clients | `AspireIntegrationTests.AddLlmTck_BuildsAppHostInTestAndSupportsConfiguredClientsAsync` |
